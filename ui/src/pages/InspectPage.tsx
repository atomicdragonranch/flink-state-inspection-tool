  ...
  return (
    <Box>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Discover operators and browse keyed or operator state entries
      </Typography>
      ...
      {!singleResult && !activeMutation.isPending && !activeMutation.isError && operators.length === 0 && (
        <Paper
          sx={{
            p: 5,
            mb: 3,
        ...
        >
          <ManageSearchIcon sx={{ fontSize: 48, color: "rgba(80, 144, 211, 0.4)", mb: 2 }} />
          <Typography variant="h6" sx={{ color: "rgba(255,255,255,0.7)", mb: 1 }}>
            No state loaded
          </Typography>
          <Typography variant="body2" color="text.secondary">
            Enter a checkpoint path and click Discover Operators to get started
          </Typography>
        </Paper>
      )}
